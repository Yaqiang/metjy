 ...
 */
package org.meteothink.math.meteo;
...
public class MeteoMath {
    ...
    public static Array press2Height(Array press) {
        ...
        double rh;
        IndexIterator iterP = press.getIndexIterator();
        IndexIterator iterR = r.getIndexIterator();
        while(iterP.hasNext()) {
            rh = MeteoMath.press2Height(iterP.getDoubleNext());
            iterR.setDoubleNext(rh);
        }
    ...
    public static Array height2Press(Array height) {
        ...
        double rh;
        IndexIterator iterH = height.getIndexIterator();
        IndexIterator iterR = r.getIndexIterator();
        while(iterH.hasNext()) {
            rh = MeteoMath.height2Press(iterH.getDoubleNext());
            iterR.setDoubleNext(rh);
        }
